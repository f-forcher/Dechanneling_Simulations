...
//
//	//histogramAm   -> Draw();
//	//histogramCh   -> Draw("same"); Documents
...
// TODO se devo simulare sia dechanneling che VRAM, il suffisso deve essere lo stesso (new3 o newVRAM3), mettere altro parametro
	...
	string canvas_name_2Dorig = "Crystal simulation: " + nomecrys + "2D histo, orig";
	auto c2Dorig= new TCanvas( "c2Dorig", canvas_name_color.c_str() );
	c2Dorig->cd();
